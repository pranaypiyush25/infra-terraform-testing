...
locals {
  ...
  vpc = {
    ...
    subnet = {
      ...
      cluster_EIP                          = ["3.101.6.205","54.193.151.115"]         # list the exisitng EIPs,   i.e   "20.20.20.20", "30.30.30.30"
      worker_AZ                            = ["us-west-1a","us-west-1b"]         # list the worker AZ,       i.e   "ap-south-1a","ap-south-1b"
      worker_EIP                           = ["3.101.6.205","54.193.151.115"],         # list the exisitng EIPs,   i.e   "20.20.20.20", "30.30.30.30"
