...
locals {
  ...
  vpc = {
    ...
    subnet = {
      ...
      cluster_EIP                          = ["13.56.98.144","54.177.191.111"]         # list the exisitng EIPs,   i.e   "20.20.20.20", "30.30.30.30"
      worker_AZ                            = ["us-west-1a","us-west-1b"]         # list the worker AZ,       i.e   "ap-south-1a","ap-south-1b"
      worker_EIP                           = ["204.236.188.210","54.219.129.210"]         # list the exisitng EIPs,   i.e   "20.20.20.20", "30.30.30.30"
