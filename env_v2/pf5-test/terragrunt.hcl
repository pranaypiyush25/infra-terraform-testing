...
locals {
  ...
  vpc = {
    ...
    subnet = {
      ...
      cluster_EIP                          = ["52.9.130.83","54.215.20.152"]         # list the exisitng EIPs,   i.e   "20.20.20.20", "30.30.30.30"
      worker_AZ                            = ["us-west-1a","us-west-1b"]         # list the worker AZ,       i.e   "ap-south-1a","ap-south-1b"
      worker_EIP                           = ["54.215.44.73","54.215.74.215"]         # list the exisitng EIPs,   i.e   "20.20.20.20", "30.30.30.30"
