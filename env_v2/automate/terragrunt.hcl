...
locals {
  ...
  worker = {
    keyname                               = "sec_manager"     # create ssh key name and update
    generic = {
  ...
  mongodbatlas = {
    ...
    project = {
      ...
      cluster = {
        ...
        provider_instance_size_name = "sec_manager"
        disk_size_gb = 40
      }
    }
  }
  ...
  elasticache = {
    ...
    replication_groups = {
      ...
      parameter_group_name = "sec_manager"
