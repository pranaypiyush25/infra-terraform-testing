...
locals {
  ...
  vpc = {
    ...
    subnet = {
      ...
      cluster_EIP                          = [13.52.40.252,13.56.185.109]         # list the exisitng EIPs,   i.e   "20.20.20.20", "30.30.30.30"
      worker_AZ                            = ["us-west-1a", "us-west-1c"]         # list the worker AZ,       i.e   "ap-south-1a","ap-south-1b"
      worker_EIP                           = [13.52.40.252,13.56.185.109],         # list the exisitng EIPs,   i.e   "20.20.20.20", "30.30.30.30"
